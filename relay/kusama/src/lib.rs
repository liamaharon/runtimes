...
pub mod migrations {
	...
	/// Clean up undecodable Locks and Session keys.
	/// See <https://github.com/polkadot-fellows/runtimes/issues/104> and
	/// <https://github.com/polkadot-fellows/runtimes/issues/145>
	mod dry_run_undecodable_key_cleanup {
		use super::*;
		use hex_literal::hex;
		...
		const LOCKS: [[u8; 64]; 19] = [
			hex!("c2261276cc9d1f8598ea4b6a74b15c2f218f26c73add634897550b4003b26bc625dd314d5cf9255ed0f3bdf2589adc292f47aed28c0690f788ed2dbceb1fc3ff"),
			hex!("c2261276cc9d1f8598ea4b6a74b15c2f218f26c73add634897550b4003b26bc6386a9e3f0e74067eef90a9a281c234e05d6fa9c4a25b20fd03913b81d7fccf13"),
			hex!("c2261276cc9d1f8598ea4b6a74b15c2f218f26c73add634897550b4003b26bc6402fc69a7eb122806b64c9e27735e45009aa922e1ba4675758c75607a96a2172"),
			hex!("c2261276cc9d1f8598ea4b6a74b15c2f218f26c73add634897550b4003b26bc645c200adc666cca26df86e2e4a5aa1af186606b9e2a5b86c14cc954228a3cd00"),
			hex!("c2261276cc9d1f8598ea4b6a74b15c2f218f26c73add634897550b4003b26bc651e634907ab2f0b63eadc4091e366f51bcf6f73763f216dcf716cfe7757813e7"),
			hex!("c2261276cc9d1f8598ea4b6a74b15c2f218f26c73add634897550b4003b26bc65abb1b03f39287c41885312b50a18dc337de40d15f99c182eba0e5aa6629b9bc"),
			hex!("c2261276cc9d1f8598ea4b6a74b15c2f218f26c73add634897550b4003b26bc69bc93667f57a17c791c766082c5278860748fc9d5b032f77020cd6f5f0cac404"),
			hex!("c2261276cc9d1f8598ea4b6a74b15c2f218f26c73add634897550b4003b26bc6037a8e00a50bc1c33d6e5bbe743128e028b354a0aaf56a0e589331f1219c7210"),
			hex!("c2261276cc9d1f8598ea4b6a74b15c2f218f26c73add634897550b4003b26bc612b8dfc2b39bf2dd5a8c9bfe3df728c83660a5c3c5f9f7f89a5b897f50d53ffb"),
			hex!("c2261276cc9d1f8598ea4b6a74b15c2f218f26c73add634897550b4003b26bc618cd693190ba358fbfc1356eb81bb69ae584c0177e35deb07816439849f4126f"),
			hex!("c2261276cc9d1f8598ea4b6a74b15c2f218f26c73add634897550b4003b26bc622c01c18d09f05a1912294e3627b64716471e4c0c9f3fb65927ad2d13665b8af"),
			hex!("c2261276cc9d1f8598ea4b6a74b15c2f218f26c73add634897550b4003b26bc6c2225839fbac064a294874fa1e2735e03a536f3a813ddd37942708e37863d744"),
			hex!("c2261276cc9d1f8598ea4b6a74b15c2f218f26c73add634897550b4003b26bc6c399a325d8243855816bd296c0f09e3ed891e5444b629da318eabe05a59a6924"),
			hex!("c2261276cc9d1f8598ea4b6a74b15c2f218f26c73add634897550b4003b26bc6cb1adf3e69c1f58a1bbedb997abded4575ef5b6b7cb135291c8830fbaba1a1fa"),
			hex!("c2261276cc9d1f8598ea4b6a74b15c2f218f26c73add634897550b4003b26bc6cbb919d989fe3db6c51a99b3e815cc87420183611af15bb9bbf2a5796d0d2d6f"),
			hex!("c2261276cc9d1f8598ea4b6a74b15c2f218f26c73add634897550b4003b26bc6d7d4156474119ca75bfde6e4f9b80124548152410172145ef8f338015f95d24b"),
			hex!("c2261276cc9d1f8598ea4b6a74b15c2f218f26c73add634897550b4003b26bc6e1dd89c4762c59f8ae6fb3aa0336a25682d27e847ca43db3d4b8921d230c5e21"),
			hex!("c2261276cc9d1f8598ea4b6a74b15c2f218f26c73add634897550b4003b26bc6f233e7a4244e2db9351ec357ce0bf89c083920c830df0279c4e2d42229f355e7"),
			hex!("c2261276cc9d1f8598ea4b6a74b15c2f218f26c73add634897550b4003b26bc6f2a3cf0b5ed1c671b3fe9578dbc8bd24fd1e5a8aeffcd13901423bd5977154da"),
		];
		...
		impl frame_support::traits::OnRuntimeUpgrade for Migration {
			fn on_runtime_upgrade() -> Weight {
				...
				for k in LOCKS.into_iter() {
					log::info!("Getting Lock from storage {:?}", array_bytes::bytes2hex("0x", &k));
					...
					frame_support::storage::unhashed::kill(&k);
					log::info!("Killed");
				}

				// Check and remove session keys
				use sp_std::collections::btree_set::BTreeSet;
				let validators_with_undecodable_entries =
					SESSION_ADDRESSES.into_iter().collect::<BTreeSet<_>>();
				...
				let session_keys = SESSION_ADDRESSES
					.into_iter()
					.map(|k| [SESSION_KEY_PREFIX.as_ref(), k.as_ref()].concat())
					.collect::<Vec<_>>();
				for k in session_keys.iter() {
					frame_support::storage::unhashed::kill(k.as_slice());
				}

				// Construct referenda call
				let combined_vec = LOCKS
					.to_vec()
					.into_iter()
					.map(|k| k.to_vec())
					.chain(session_keys.into_iter().map(|k| k.to_vec()))
					.collect::<Vec<_>>();
				let call = RuntimeCall::System(frame_system::Call::<Runtime>::kill_storage {
					keys: combined_vec,
				})
				.encode();
				log::info!("Call: {:?}", array_bytes::bytes2hex("0x", call));
	...
	pub type Unreleased = (
		dry_run_undecodable_key_cleanup::Migration,
